...
export const TourProposalModal: React.FC<TourProposalModalProps> = ({
  ...
  const [title, setTitle] = useState('Goa Beach Trip 2027');
  ...
  const [hotel, setHotel] = useState(15000);
  const [food, setFood] = useState(10000);
  const [activity, setActivity] = useState(7000);
  const [emergency, setEmergency] = useState(5000);
