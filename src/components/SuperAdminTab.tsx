    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm">
          ...
          <p className="text-[11px] text-emerald-600 font-medium mt-1">Active on platform</p>
        </div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm">
          ...
          <p className="text-[11px] text-emerald-600 font-medium mt-1">Verified members</p>
        </div>

        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm">
          <div className="flex items-center justify-between text-xs text-slate-500">
            <span>Platform Circles MRR</span>
            <TrendingUp className="w-4 h-4 text-emerald-600" />
          </div>
          <div className="text-2xl font-bold text-emerald-700 mt-2 font-mono">
            ₹0/mo
          </div>
          <p className="text-[11px] text-slate-400 mt-1">Free community tier active</p>
        </div>
          ...
          {circles.map((c) => (
            <div key={c.id} className="py-3 flex items-center justify-between">
              ...
              <div className="text-right text-xs">
                ...
                <div className="text-slate-500">{c.expectedMembers || 0} members</div>
              </div>
            </div>
          ))}
        </div>
